...
include('conn.php');
$record_count=$conn->query("SELECT * FROM posts where category_id='7'");
$per_page=2;
...
$prev = $page - 1;
$next = $page + 1;
$query=$conn->prepare("SELECT post_id,posted,  title, LEFT  (body,100) as  body, category from posts inner join category ON category.category_id=posts.category_id  where posts.category_id='7' ORDER BY post_id DESC limit $start, $per_page");
$query->execute();
